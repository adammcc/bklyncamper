var BkRowFourEight = React.createClass({
  render: function () {
    return (
      <div className="bk-article-row row">
        ...
        <div className="bk-article-row__box bk-dashed-border-left col-sm-8">
          <a href={ "#article/" + this.props.articles[1] }>
            <BkBox long={ true } src={ info[this.props.articles[1]].src } alt={ info[this.props.articles[1]].alt } key={ info[this.props.articles[1]].alt } title={info[this.props.articles[1]].title} pics={ info[this.props.articles[1]].pics }>
